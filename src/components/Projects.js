...
export default function Projects() {
    const projectsData = [ 
       ...
       {name: "Read Rubixx", isApp: true, img: rubixPic, skills:["EJS","CSS", "JavaScript", "Node Js", "Express","PDF Js", "MongoDB"], link: "https://rubix-29685b9cfc62.herokuapp.com/",github : "https://github.com/paulthechampion/rubix", words:"Rubixx is a Full-stack online book library, it saves authors and their books. Also enables users to read books. This as created using the MERN stack as well as PDF.js library to read the books"},  
        ...
        {name: "Todo App", isApp: true, img: todoPic, skills:["CSS", "JavaScript", "Node Js", "Express","React Js", "MongoDB",], link: "https://champs-todo-f3bcd56ea02c.herokuapp.com/",github : "https://github.com/paulthechampion/todoApp", words:"A Full-stack Todo app, saves Todo tasks and arranges them in a tabular format"}
    ]
